 ...
 */
@WebServlet(name = "GaLeryServlet", urlPatterns = {"/GaLeryServlet"})
        ...
        try {
            ...
            if (invalid == true) {
                ...
                try {
                    ...
                    for (Image img : imagelList) {
                        imgUrl.add(img.getImage_url());
                    }
            ...
            request.getRequestDispatcher("Gallery1.jsp").forward(request, response);
        } catch (Exception ex) {
